...
link = "http://rj.portaldatransparencia.com.br/prefeitura/areal/"
...
while continuar:
    ...
    if "Nenhum registro localizado" not in div:
        ...
        link_pdf = "http://rj.portaldatransparencia.com.br/prefeitura/areal/index.cfm?pagina=abreDocumento&arquivo=" + codigo
