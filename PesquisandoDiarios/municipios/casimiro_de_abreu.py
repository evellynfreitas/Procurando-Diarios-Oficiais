...
class Casimiro:
    def __init__(self, pesquisa, data_inicial, data_final):
        ...
        self.url = 'https://transparencia.casimirodeabreu.rj.gov.br/jornal.php?Num=&Sec=&dtini=' + data_inicial + \
    ...
    def retornaDiarios(self):
        ...
        while True:
            ...
            for a in lista_a:
                ...
                link = 'https://transparencia.casimirodeabreu.rj.gov.br/' + codigo.replace(' ', '%20')
