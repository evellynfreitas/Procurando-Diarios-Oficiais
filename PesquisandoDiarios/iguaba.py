...
class Iguaba:
    def __init__(self, pesquisa, data_inicial, data_final):
        ...
        self.url = 'https://www.portal.iguaba.rj.gov.br/jornal.php?Num=&Sec='
    ...
    def retornaDiarios(self):
        ...
        while True:
            ...
            for a in lista_a:
                url = 'https://www.portal.iguaba.rj.gov.br/' + a['href']
                site = requests.get(url)
                site = BeautifulSoup(site.text, "html.parser")

                codigo = site.find('a', class_='btn btn-primary btn-sm pull-right')['href'].replace(' ', '%20')
                link = 'https://www.portal.iguaba.rj.gov.br/' + codigo
